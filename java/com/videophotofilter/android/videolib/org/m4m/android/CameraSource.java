...
import com.videophotofilter.android.videolib.org.m4m.domain.graphics.Program;
import com.videophotofilter.android.videolib.org.m4m.domain.graphics.TextureRenderer;
import com.videophotofilter.android.videolib.org.m4m.domain.graphics.TextureType;
import com.videophotofilter.android.videolib.org.m4m.domain.pipeline.TriangleVerticesCalculator;

import com.videophotofilter.android.videolib.org.m4m.domain.Command;
import com.videophotofilter.android.videolib.org.m4m.domain.CommandQueue;
...
import com.videophotofilter.android.videolib.org.m4m.domain.IOnFrameAvailableListener;
...
import com.videophotofilter.android.videolib.org.m4m.domain.Resolution;
...
public class CameraSource extends com.videophotofilter.android.videolib.org.m4m.domain.CameraSource {
    ...
    private class SurfaceTextureManager implements SurfaceTexture.OnFrameAvailableListener {
        ...
        public SurfaceTextureManager(CommandQueue commandQueue, IEglUtil eglUtil) {
            ...
            this.eglUtil = eglUtil;
            textureRender = new STextureRender(eglUtil);
