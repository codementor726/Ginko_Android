...
package com.videophotofilter.android.videolib.media;
...
{
    public static final int HandleSize = 60;
    ...
    private boolean percentToPosition(int startPos, int endPos) {
        int startP = (int) (mDuration * startPos / 100);
        int endP   =  (int) (mDuration * endPos / 100);
            ...
            case MotionEvent.ACTION_MOVE:
            {
                if (mHandleToMove != null)
                {
                    ...
                    if (position > 0 && position < 100)
                    {
                        ...
                        {
                            if(!percentToPosition(position, getEndPosition()))
                                break;
                        ...
                        {
                            if(!percentToPosition(getStartPosition(), position))
                                break;
