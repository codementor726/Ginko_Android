...
public class AspectFrameLayout extends FrameLayout {
    private static final String TAG = "AspectFrmaeLayout";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mTargetAspect > 0) {
            ...
            if (Math.abs(aspectDiff) < 0.01) {
                ...
                int newWidth = MeasureSpec.makeMeasureSpec(initialWidth, MeasureSpec.EXACTLY);
                int newHeight = MeasureSpec.makeMeasureSpec(initialHeight, MeasureSpec.EXACTLY);
                
                this.setPadding((widthMeasureSpec-newWidth)/2, //left
                				(heightMeasureSpec-newHeight)/2, //top
                				(widthMeasureSpec-newWidth)/2,//right
                				(heightMeasureSpec-newHeight)/2//bottom
                				);*/
