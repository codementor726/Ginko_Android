...
public class DragableGPUImageView extends GPUImageView{

	public DragableGPUImageView(Context context) {
		super(context);
	}

	public DragableGPUImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	private void setFrame(int current_Left2, int current_Top2,
			int current_Right2, int current_Bottom2) {
	...
	class MyAsyncTask extends AsyncTask<Void, Integer, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			while (current_Width <= screen_W) {
                ...
                Logger.error("top=" + top + ",bottom=" + bottom + ",left=" + left + ",right=" + right);
