...
public class DragableNetworkImageView extends CustomNetworkImageView {
    int screenWidth;
    int screenHeight;
    int lastX;
    int lastY;
    ...
    public DragableNetworkImageView(Context context, AttributeSet attribute) {
        this(context, attribute, 0);
    }

    public DragableNetworkImageView(Context context, AttributeSet attribute, int style) {
