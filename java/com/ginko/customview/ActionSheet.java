...
public class ActionSheet extends Fragment implements OnClickListener {
	...
	private final int BG_VIEW_ID = 10;
	private final int TRANSLATE_DURATION = 200;
	...
	private Attributes readAttribute() {
        ...
        attrs.cancelButtonPadding = (int)a.getDimension(
                R.styleable.ActionSheet_actionSheetCancelButtonPadding, attrs.cancelButtonPadding);
	...
	private static class Attributes {
		...
		public Attributes(Context context) {
            ...
            this.cancelButtonPadding = dp2px(10);
