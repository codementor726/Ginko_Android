        ...
        ImageContainer newContainer = mImageLoader.get(mUrl,
                new ImageListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (mErrorImageId != 0) {
                            CustomNetworkImageView.this.setScaleType(ScaleType.FIT_CENTER);
                    ...
                    public void onResponse(final ImageContainer response,
                        ...
                        if (response.getBitmap() != null) {
                            ...
                            {
                                CustomNetworkImageView.this.setScaleType(ImageView.ScaleType.FIT_XY);
                            ...
                            else
                            {
                                ...
                                {
                                    CustomNetworkImageView.this.setScaleType(definedScaleType);
                                }
                                setImageBitmap(response.getBitmap());
                            }
