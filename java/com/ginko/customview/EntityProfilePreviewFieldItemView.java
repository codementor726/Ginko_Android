...
public class EntityProfilePreviewFieldItemView extends LinearLayout{
    private Context mContext;
    private EntityInfoDetailVO itemInfo;
    private ImageView imgFieldIcon;
    private TextView txtFieldValue;

    public EntityProfilePreviewFieldItemView(EntityInfoDetailVO itemInfo, Context context) {
        this(context);
        this.itemInfo = itemInfo;
        init(context);
    }

    public EntityProfilePreviewFieldItemView(Context context) {
        this(context, null);
    }

    public EntityProfilePreviewFieldItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EntityProfilePreviewFieldItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        txtFieldValue.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(itemInfo == null) return;
                String fieldValue = itemInfo.getValue();
                String fieldType = itemInfo.getType();
    ...
    public EntityProfilePreviewFieldItemView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context)
    {
        ...
        if(strFieldName.toLowerCase().contains("hours"))
        {
