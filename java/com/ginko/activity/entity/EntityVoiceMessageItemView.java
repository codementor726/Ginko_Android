...
public class EntityVoiceMessageItemView extends MessageItemView
                                    implements VoiceMessagePlayer.VoiceMessagePlayerCallback
{
    ...
    public EntityVoiceMessageItemView(Context context) {
        super(context);

    }

    public EntityVoiceMessageItemView(Context context, EntityMessageVO messageItem) {
