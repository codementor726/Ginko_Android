...
public class ContactItemComparator implements Comparator<ContactItem> {
    ...
    public ContactItemComparator(Context context , boolean _isSortByFName)
    {
        this.isSortByFName = _isSortByFName;
    }
    ...
    public int compare(ContactItem left, ContactItem right) {
        ...
        if(isSortByFName)
        {
            leftName = left.getFirstName() + left.getLastName();
            rightName = right.getFirstName() + right.getLastName();
        }
        else
        {
            leftName = left.getLastName() + left.getFirstName();
            rightName = right.getLastName() + right.getFirstName();
        }
