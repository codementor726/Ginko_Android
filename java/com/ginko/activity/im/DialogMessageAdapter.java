 ...
 */
public class DialogMessageAdapter extends BaseAdapter implements ImDownloadManager.ImDownloadListener {
    private final int INT_EXTRA_PURPLE  = 1133;

    private GroupVideoChatActivity boardActivity;
    ...
    public DialogMessageAdapter(Context context , ImBoardVO boardInfo)
    {
        mContext = context;
        boardActivity = (GroupVideoChatActivity)context;
            ...
            switch(type)
            {
                ...
                case ImMessageVO.MSG_TYPE_VOICE:
                    ...
                    imgBtnPlayStop.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            MyApp.getInstance().showSimpleAlertDiloag(mContext, "You can't play  voice while calling.", null);
                        }
                    });
                    break;
                    ...
                    public void onCompleted(JsonResponse<PurpleContactWholeProfileVO> response) {
                        if (response.isSuccess()) {
                            ...
                            if (responseData.getSharingStatus() == 4) {
                                ...
                                GroupVideoChatActivity parentActivity = (GroupVideoChatActivity) mContext;
