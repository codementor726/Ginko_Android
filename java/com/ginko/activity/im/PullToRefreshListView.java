...
public class PullToRefreshListView extends ListView {
    ...
    private OnSinglePointTouchListener singlePointTouchListener;

    public interface OnSinglePointTouchListener
    {
        public void onSinglePointTouchEvent();
    }

    public void setOnSinglePointTouchListener(OnSinglePointTouchListener listener)
    {
        this.singlePointTouchListener = listener;
    }
    ...
    {
        this.refreshEnable = isRefreshable;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if((System.currentTimeMillis()-this.lastTouchDownTime<200L) &&
                        (Math.abs(event.getX()-this.downX)<30.0f) &&
                        (Math.abs(event.getY()-this.downY)<30.0f))
                    if (this.singlePointTouchListener != null)
                        this.singlePointTouchListener.onSinglePointTouchEvent();
                if (previousY != -1
