 ...
 */
public class LocationMessageItemView extends MessageItemView{
    ...
    public LocationMessageItemView(Context context) {
        super(context);
    }

    public LocationMessageItemView(Context context, ImBoardVO board, ImMessageVO messageItem, HashMap<Integer, ImBoardMemeberVO> entireMemberList) {
