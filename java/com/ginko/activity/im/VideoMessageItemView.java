 ...
 */
public class VideoMessageItemView extends MessageItemView{
    ...
    public VideoMessageItemView(Context context) {
        super(context);
    }

    public VideoMessageItemView(Context context, ImBoardVO board , ImMessageVO messageItem, HashMap<Integer, ImBoardMemeberVO> entireMemberList) {
