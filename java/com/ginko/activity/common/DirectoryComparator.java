 ...
 */
public class DirectoryComparator implements Comparator<DirectoryInviteContactItem> {
    public DirectoryComparator(Context context)
    {
    }

    @Override
    public int compare(DirectoryInviteContactItem lhs, DirectoryInviteContactItem rhs) {
