...
public class UserProfileFragment extends Fragment {
     ...
     */
    public static UserProfileFragment newInstance(String type) {
        UserProfileFragment fragment = new UserProfileFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, type);
        args.putSerializable(GROUP_INFO, null);
        fragment.setArguments(args);
        return fragment;
    }

    public static UserProfileFragment newInstance(String type,UserUpdateVO groupInfo) {
        UserProfileFragment fragment = new UserProfileFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, type);
    ...
    public void init(UserUpdateVO workInfo) {
        ...
        for(int i=0; i<groupInfo.getImages().size(); i++)
        {
            if(groupInfo.getImages().get(i).getZIndex() == 0 && backgroundPhotoUrl.equals(""))
                backgroundPhotoUrl = groupInfo.getImages().get(i).getUrl();
            else if(groupInfo.getImages().get(i).getZIndex() == 1 && foregroundPhoto == null)
            {
                foregroundPhoto = groupInfo.getImages().get(i);
            }
        }
        ...
        //foreground photo
        if(groupInfo.getImages()!= null && groupInfo.getImages().size()>0 && foregroundPhoto != null)
        {
    ...
    public void reShowForAbbr(boolean abbr) {
        ...
        for (UserProfileVO field : this.groupInfo.getFields()) {
