...
public class UserEntityProfileFragment extends Fragment {
     ...
     */
    public static UserEntityProfileFragment newInstance(UserEntityProfileVO _entity , EntityInfoVO _entityInfo) {
        UserEntityProfileFragment fragment = new UserEntityProfileFragment();
    ...
    public UserEntityProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(entity == null)
                    return;
                if(entity.getVideoUrl() == null || entity.getVideoUrl().equals(""))
                    return;
                try {
                    Intent videoPlayIntent = new Intent(Intent.ACTION_VIEW);
                    videoPlayIntent.setDataAndType(Uri.parse(entity.getVideoUrl()), "video/*");
    ...
    public void setNullFavorite() {
        ...
        imgProfileFavorite.setVisibility(View.INVISIBLE);
    }
    public void setShowFavorite() {
        isFavorite = false;
        imgProfileFavorite.setImageResource(R.drawable.img_unfavorite);
        imgProfileFavorite.setVisibility(View.VISIBLE);
    }
    ...
    public void init(UserEntityProfileVO _entity , EntityInfoVO _entityInfo)
    {
        ...
        if(this.entity.getVideoUrl() == null || this.entity.getVideoUrl().equals(""))
        {
        ...
        ArrayList<EntityInfoDetailVO> hoursFields = null ,
                mobileFields = null,
                emailFields = null ,
                addressFields = null ,
                faxFields = null,
...
*/
        ...
        if(entityInfo.getLatitude() != null) {
            try {
        ...
        if(entityInfo.getLongitude() != null) {
            try {
