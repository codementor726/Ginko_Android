...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private boolean autoLoadOnTop = false;
    /**是否截断touch事件*/
    ...
    public boolean isAutoLoadOnTop() {
		return autoLoadOnTop;
	}

	public void setAutoLoadOnTop(boolean autoLoadOnTop) {
		this.autoLoadOnTop = autoLoadOnTop;
	}
