    ...
    public void onDraw(final int textureId, final FloatBuffer cubeBuffer,
        ...
        if (mMergedFilters != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (i == 0) {
                    filter.onPreDraw(previousTexture, cubeBuffer, textureBuffer);
                } else if (i == size - 1) {
                    filter.onPreDraw(previousTexture, mGLCubeBuffer, (size % 2 == 0) ? mGLTextureFlipBuffer : mGLTextureBuffer);
                } else {
                    filter.onPreDraw(previousTexture, mGLCubeBuffer, mGLTextureBuffer);
                }
