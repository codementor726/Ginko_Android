...
public class GPUImageFilter {
    ...
    public void onDraw(final int textureId, final FloatBuffer cubeBuffer,
        ...
        if (misVideoRecording == true)
    	{
    		saveRenderState();
            if (mRecorder != null && mRecorder.firstTimeSetup()) {
                if (mRecorder != null) mRecorder.makeCurrent();
            } else {
                if (mRecorder != null) mRecorder.makeCurrent();
            }
    ...
    public void onPreDraw(final int textureId, final FloatBuffer cubeBuffer,
            final FloatBuffer textureBuffer) {
    ...
    public void setVideoRecorder(int width, int height, MyRecorder recorder, boolean isVideoRecording)
    {
    	mVideoWidth = width;
    	mVideoHeight = height;
    	mRecorder = recorder;
    	misVideoRecording = isVideoRecording;
    }
}
