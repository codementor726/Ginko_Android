...
public class HListView extends AbsHListView {
	...
	public HListView( Context context, AttributeSet attrs, int defStyle ) {
		...
		if( null != array ) {
			...
			footerHeight = array.getDimensionPixelSize(R.styleable.HListView_hlv_footerHeight , 0);
			...
			if( LOG_ENABLED ) {
				...
				Log.d( LOG_TAG, "footerHeight: " + footerHeight );
	...
	static private class ArrowScrollFocusResult {
		...
		/**
		 * How { it.sephiroth.android.library.widget.HListView#arrowScrollFocused} returns its values.
		 */
	...
	protected void dispatchDraw( Canvas canvas ) {
		...
		if ( drawDividers || drawOverscrollHeader || drawOverscrollFooter ) {
			...
			if ( !mStackFromRight ) {
				...
				bounds.top = bounds.bottom-mFooterHieght;
	...
	{
		if( LOG_ENABLED ) {
			Log.i( LOG_TAG, "setFooterHeight: " + height );
		}
		mFooterHieght = height;
		invalidate();
	}
	/**
